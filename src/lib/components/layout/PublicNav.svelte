<script lang="ts">
  // PublicNav for landing, login, register pages
</script>
...
<header class="border-b border-zinc-850 bg-zinc-950/80 backdrop-blur-md sticky top-0 z-50">
  <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
    ...
    <nav class="flex items-center gap-4">
      ...
      <a href="/register" class="bg-indigo-650 hover:bg-indigo-500 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all">
        Sign Up
      </a>
    </nav>
  </div>
